...
Revision ID: c270ab90d65d
Revises: ef1234567890
Create Date: 2025-12-27 19:21:00.676799
...
def downgrade() -> None:
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.CheckConstraint("type::text = ANY (ARRAY['general'::character varying, 'group'::character varying, 'personal'::character varying, 'system'::character varying, 'social'::character varying, 'event'::character varying]::text[])", name=op.f('check_notification_type')),
    sa.ForeignKeyConstraint(['tenant'], ['tenants.id'], name=op.f('notifications_tenant_fkey')),
    ...
    sa.Column('type', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.CheckConstraint("type::text = ANY (ARRAY['web'::character varying, 'android'::character varying, 'ios'::character varying, 'other'::character varying]::text[])", name=op.f('check_fb_token_type')),
    sa.ForeignKeyConstraint(['tenant'], ['tenants.id'], name=op.f('fb_tokens_tenant_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('fb_tokens_pkey'))
    )
    ...
    sa.Column('videos', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=False),
    sa.Column('tags', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=False),
    sa.Column('links', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=False),
